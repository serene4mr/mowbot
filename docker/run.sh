...
print_help() {
    ...
    echo "  --module        Specify the module (default: core)"
    ...
    echo ""
    echo "Examples:"
    echo "  ./run.sh                    # Run core development environment"
    echo "  ./run.sh --cuda             # Run core CUDA development environment"
    echo "  ./run.sh --runtime          # Run core production runtime"
